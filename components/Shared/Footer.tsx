            ...
            <div className=' w-10/12 md:w-8/12 mx-auto py-10 flex justify-between items-center'>
                <div className=' flex items-center gap-3 justify-between w-full flex-col md:flex-row'>
                    ...
                    <div className=' flex gap-3'>
                        <Link href="/contact" className=' hover:underline underline-offset-4' >Contact Me</Link>
                        <a href={constant.personalDetails.resume}  className=' hover:underline underline-offset-4' target="_blank" rel="noopener noreferrer">Resume Link</a>
                    </div>
                </div>
            </div>
        </footer>
