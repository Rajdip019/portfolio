...
const PersonalExperiences = () => {
    ...
    return (
        <motion.section
            ...
            className=' my-24 flex flex-col md:items-center md:block'>
            <h1 className=' text-2xl font-semibold text-gray-200 text-center md:text-left mb-5'>Personal Achievements</h1>
                <div className='bg-black rounded-lg p-5 border-gray-800 border transition-all'>
                    ...
                    <ul className='text-gray-200 mb-5 flex flex-col gap-3'>
                        ...
                        <li>🗣️ Youngest speaker at Azure Cosmos DB Cloud Conference (2022)</li>
                        ...
                        <li>⭐️ Speaker at College Google Developer Student Club and multiple local Dev Conferences.</li>
                    </ul>
